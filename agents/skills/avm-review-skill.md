...
forked-from: https://github.com/hashicorp/agent-skills/blob/main/terraform/code-generation/skills/azure-verified-modules/SKILL.md
fork-notes: |
  Microsoft AVM is moving toward azapi as the preferred provider for new modules.
  The Azure Provider Requirements section below has been amended to reflect this direction.
  All other requirements are unchanged from the upstream HashiCorp skill.
---
...
**Example (acceptable for existing azurerm-based modules):**
...
Any breaking change **MUST** be documented in `UPGRADE.md`.
...
- [ ] Azure providers (azapi preferred; azurerm acceptable for existing modules) versions meet AVM requirements
...
- [ ] Breaking changes reviewed and documented in `UPGRADE.md`
...
*Fork: azapi-first amendment applied for Microsoft AVM direction*
